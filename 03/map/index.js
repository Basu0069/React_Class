...
function displayImg(){
    ...
    data.map(item => { 
        `<div class="card size-[40%] border mx-auto bg-slate-200 text-center">
        <div class=" w-full-h-[50%] bg-red-300 mx-auto">
            <img src="${data.image}" alt="" id="img" >image
        </div>
        <div>
            <p id="head">${data.title}</p>
            <p id="des">${data.despciption}</p>
